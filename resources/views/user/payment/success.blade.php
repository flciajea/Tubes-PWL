                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <h6>{{ $order->event->event_date->format('d F Y') }}</h6>
                                    </div>
                                    <div class="mb-3">
                                        <small class="text-muted">Waktu</small>
                                        <h6>{{ $order->event->event_date->format('H:i') }} WIB</h6>
                                    </div>
                                    <div class="mb-0">
                                        <small class="text-muted">Lokasi</small>
                                        <h6>{{ $order->event->location }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <h6>@foreach($order->orderItems as $item)
                                            <h6>{{ $item->ticketType->name }}</h6>
                                        @endforeach
                                        </h6>
                                    </div>
                                    <div class="mb-3">
                                        <small class="text-muted">Jumlah</small>
                                        <h6>{{ $order->quantity }} Tiket</h6>
                                    </div>
                                    <div class="mb-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <a href="{{ route('user.payment.download-ticket', $order->id) }}"
