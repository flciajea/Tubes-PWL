                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control form-control-sm" 
                                       placeholder="Cari Event..." id="filterEvent">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                @forelse ($payments as $payment)
                                    <tr>
                                        ...
                                        <td>
                                            <strong>{{ Str::limit($payment->ticketRegistration->event->title, 25) }}</strong>
                                            <br>
                                            <small class="text-muted">
                                                {{ $payment->ticketRegistration->registration_code }}
                                            </small>
                                        </td>
                                        <td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    @if ($payment->status === 'pending')
                                                        <li>
                                                            <a class="dropdown-item" 
                                                               href="{{ route('user.payment.show', $payment->ticketRegistration->id) }}">
                                                    ...
                                                    @if ($payment->status === 'success')
                                                        <li>
                                                            <a class="dropdown-item" 
                                                               href="{{ route('user.payment.download-ticket', $payment->ticketRegistration->id) }}">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" 
                                                           href="{{ route('user.events.show', $payment->ticketRegistration->event->id) }}">
                                            ...
                                            <div class="row p-3 bg-light">
                                                <div class="col-md-4">
                                                    ...
                                                    <p class="mb-1">
                                                        ...
                                                        <strong>{{ $payment->ticketRegistration->created_at->format('d M Y H:i') }}</strong>
                                                    </p>
                                                    <p class="mb-0">
                                                        <small class="text-muted">Tiket Type:</small><br>
                                                        <strong>{{ $payment->ticketRegistration->ticketType->name }}</strong>
                                                    </p>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <p class="mb-1">
                                                        ...
                                                        <strong>{{ $payment->ticketRegistration->event->event_date->format('d M Y H:i') }}</strong>
                                                    </p>
                                                    <p class="mb-0">
                                                        <small class="text-muted">Lokasi:</small><br>
                                                        <strong>{{ Str::limit($payment->ticketRegistration->event->location, 30) }}</strong>
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h4 class="text-success">
                                    Rp. {{ number_format($payments->where('status', 'success')->sum('amount'), 0, ',', '.') }}
                                </h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h4 class="text-warning">
                                    Rp. {{ number_format($payments->where('status', 'pending')->sum('amount'), 0, ',', '.') }}
                                </h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h4 class="text-danger">
                                    Rp. {{ number_format($payments->where('status', 'failed')->sum('amount'), 0, ',', '.') }}
                                </h4>
                            </div>
                        </div>
                    </div>
